...
namespace RU12
{
    public class RU12 : MonoBehaviour
    {
        //今のデッキ枚数
        Text DeckCount;
        //デッキの枚数上限
    ...
    class test
    {
        ...
        string effect = "■カウンター・クロック\nあなたがプレイヤーアタックを受けるたび、ユニットを１体選ぶ。それのレベルを＋１する。\n■ダメージブレイク\nこのユニットがクロックアップするたび、対戦相手のユニットを１体選ぶ。それに５０００ダメージを与える。";

        string flavor = "空間内の時間軸歪曲事故から生まれたユニット。術者のノイズに反応し、従来と違ったタイミングでプログラムが起動する。";
