...
namespace RU10
{
    public class RU10 : MonoBehaviour
    {
        //今のデッキ枚数
        Text DeckCount;
        //デッキの枚数上限
    ...
    class test
    {
        ...
        string effect = "■蠅魔王剣・滅亡ノ瞳\nこのユニットがフィールドに出た時、対戦相手のユニットからランダムで２体に５０００ダメージを与える。対戦相手のユニットが１体の場合、代わりにそれに１００００ダメージを与える。このユニットがアタックした時、ターン終了時までこのユニットのＢＰを＋［あなたの【悪魔】ユニット×２０００］する。このユニットがアタックした時、あなたの【昆虫】ユニットを１体選ぶ。それを破壊する。そうした場合、対戦相手のユニットを１体選ぶ。それに５０００ダメージを与える。";

        string flavor = "大魔界にその名を馳せる王の一人。その複眼は亜空間に繋がっているといわれ、吸い込んだ者を永遠の闇へと誘う。";
