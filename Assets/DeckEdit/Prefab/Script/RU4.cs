...
namespace RU4
{
    public class RU4 : MonoBehaviour
    {
        //今のデッキ枚数
        Text DeckCount;
        //デッキの枚数上限
    ...
    class test
    {
        ...
        //カードの情報
        string name = "スターフィッシュガール";
        CardRarity rarity = CardRarity.C;
        CardColor color = CardColor.赤;
        CardRace race = CardRace.海洋;
        ...
        string effect = "■ヒトデ爆弾 このユニットがオーバークロックした時、対戦相手のユニットを２体まで選ぶ。それらに５０００ダメージを与える。";

        string flavor = "星の形をした機雷を背負った海洋族の少女。改良を重ねたその機雷は爆発の威力が予想以上にあがってしまったようだ。";
