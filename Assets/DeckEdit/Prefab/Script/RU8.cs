...
namespace RU8
{
    public class RU8 : MonoBehaviour
    {
        //今のデッキ枚数
        Text DeckCount;
        //デッキの枚数上限
    ...
    class test
    {
        ...
        string effect = "【固着】\n■クロック・アップ\nあなたのターン開始時、このユニットのレベルを＋１する。\n■天地鳴動\nこのユニットがフィールドでレベル３にクロックアップした時、全てのユニットに１００００ダメージを与える。";

        string flavor = "背中に活火山を有する巨大な亜竜。その怒りに触れたが最期、大地は焼き尽くされ、マグマの海へと変わるだろう。";
