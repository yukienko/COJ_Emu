...
namespace RU7
{
    public class RU7 : MonoBehaviour
    {
        //今のデッキ枚数
        Text DeckCount;
        //デッキの枚数上限
    ...
    class test
    {
        ...
        string effect = "■ダークソウル このユニットがアタックした時、このユニットの基本ＢＰを＋［あなたの捨札の数×５００］する。";

        string flavor = "未知の暗黒物質で作られた斧を持つ騎士。その大斧を振り下ろすたび、無尽蔵に力を吸収していく。";
