...
namespace RU3
{
    public class RU3 : MonoBehaviour
    {
        //今のデッキ枚数
        Text DeckCount;
        //デッキの枚数上限
    ...
    class test
    {
        ...
        //カードの情報
        string name = "炎の魔導師ヒトミ";
        CardRarity rarity = CardRarity.UC;
        CardColor color = CardColor.赤;
        CardRace race = CardRace.魔導士;
        ...
        string effect = "■アタック・クロック あなたのユニットがアタックした時、それのレベルを＋１する。 ■紅蓮のグロウバーン このユニットがクロックアップした時、対戦相手の全てのレベル３以上のユニットに５０００ダメージを与える。\n■紅蓮のオーバーフレア あなたのユニットがフィールドでレベル３にクロックアップした時、対戦相手のユニットを１体選ぶ。それに４０００ダメージを与える。";

        string flavor = "魔術師達が集う修行場、鏡の館で修行を積んだ、炎を操る魔術師。魔術の中でもより攻撃的な術を習得している。";
