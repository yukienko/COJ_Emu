...
namespace RU13
{
    public class RU13 : MonoBehaviour
    {
        //今のデッキ枚数
        Text DeckCount;
        //デッキの枚数上限
    ...
    class test
    {
        ...
        string effect = "■宴もたけなわ\nあなたのターン終了時、このユニットのレベルを＋１する。\n■泥酔爆音頭\nこのユニットがクロックアップするたび、対戦相手のユニットからランダムで１体に５０００ダメージを与える。";

        string flavor = "酒好きだった鬼をモチーフとしたプログラム。時間経過とともにテンションが上がっていくが、限界を超えると気分が悪くなってしまう。";
